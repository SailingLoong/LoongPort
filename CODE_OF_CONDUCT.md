...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately through [GitHub's private reporting](https://github.com/SailingLoong/LoongPort/security/advisories/new) — it reaches the maintainers only and is not publicly visible. All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为可通过 [GitHub 私密报告](https://github.com/SailingLoong/LoongPort/security/advisories/new) 向负责监督的社区领袖报告 —— 该渠道只有维护者可见，不会公开。所有投诉都将得到及时和公平的审查和调查。
