...
const requiredKeys = [
  ...
  // 来源披露与站方链接，漏一个 locale 那块就显示 key 名。
  "directory.transit.detailTitle",
  "directory.transit.openDetail",
  "directory.transit.rechargeMultiplier",
  "directory.transit.minimumTopUp",
  "directory.transit.upstreamType",
  "directory.transit.reversePool",
  "directory.transit.reverseYes",
  "directory.transit.reverseNo",
  "directory.transit.colGroup",
  "directory.transit.colPlatform",
  "directory.transit.colMultiplier",
  "directory.transit.colCacheHit",
  "directory.transit.colAvailability",
  "directory.transit.colLatency",
  "directory.transit.colModels",
  "directory.transit.dataTime",
  ...
  "tierList.addSite",
  "tierList.refresh",
  // 站点配置导入弹窗与档位「站点配置」标注（SiteConfigDialog / TierItem）。
  "siteConfig.entry",
  "siteConfig.title",
  "siteConfig.description",
  "siteConfig.placeholder",
  "siteConfig.apply",
  "siteConfig.reset",
  "siteConfig.appliedToast",
  "siteConfig.resetToast",
  "tier.siteDeclared",
  "tier.siteDeclaredHint",
  "row.expand",
  "row.collapse",
  "row.notLoggedIn",
  "row.login",
  ...
  "modelVerification.evidence.diagnose",
  "modelVerification.diagnostic.title",
  "modelVerification.diagnostic.loading",
  "modelVerification.diagnostic.empty",
  "modelVerification.diagnostic.request",
  "modelVerification.diagnostic.response",
  "modelVerification.diagnostic.copy",
  "modelVerification.diagnostic.copied",
  ...
  "imagegenPlayground.parallelLabel",
  "imagegenPlayground.parallelHint",
