...
pub const DIRECTORY_STARTUP_DELAY: Duration = Duration::from_secs(5);
pub const DIRECTORY_REFRESH_INTERVAL: Duration = Duration::from_secs(6 * 60 * 60);
pub const DIRECTORY_RETRY_DELAY: Duration = Duration::from_secs(15 * 60);
