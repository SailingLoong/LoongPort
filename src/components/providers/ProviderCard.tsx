...
export function ProviderCard({
  ...
  // 官方托管路由（codex official 等）是显式账号选择，不参与故障转移健康徽章/开关。
          ...
          <div className="min-w-0 flex-1 space-y-1">
            <div className="flex flex-wrap items-center gap-2 min-h-7">
              ...
              {appId === "claude-desktop" && routingBadge === "required" && (
                <ProviderStatusBadge
                  tone="info"
                  label={t("claudeDesktop.modeProxy", {
                    defaultValue: "需要路由",
                  })}
                />
              )}
              ...
              {appId === "claude" && routingBadge === "required" && (
                <ProviderStatusBadge
                  tone="info"
                  label={t("claudeCode.needsRouting", {
                    defaultValue: "需要路由",
                  })}
                />
              )}
              ...
              {appId === "claude" && routingBadge === "unsupported" && (
                <ProviderStatusBadge
                  label={t("claudeCode.noRoutingSupport", {
                    defaultValue: "不支持路由",
                  })}
                />
              )}
