...
export type OverallStatus = "healthy" | "degraded" | "unusable" | "unreachable";
...
export interface StreamCheckResult {
  ...
  status: HealthStatus;
  /** Final backend-derived business outcome for user-facing presentation. */
