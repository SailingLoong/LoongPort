...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* **这里没有首启欢迎弹窗，是有意的。** 上游那个（`FirstRunNoticeDialog`）讲的是
          CC Switch 怎么在多个供应商之间切换，与 LoongPort 的流程无关；而且它和域名输入
          弹窗都是「flag 未确认就弹」+ zIndex=top，会叠在一起，用户得先看完一屏无关介绍
          才能摸到真正要填的东西。2026-08-04 连组件带 i18n 一起删了（一直未挂载）。
